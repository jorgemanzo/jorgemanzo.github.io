...
function hexToDec(USERINPUT) {
  var n = 0;
  var length = USERINPUT.toString().length - 1;
...
function counter(string, length) {
  var n = 0; //be the number of periods or spaces in string
  var i = void 0;
  for (i = 0; i < length; i++) {
...
function hexToBin(USERINPUT) {
  var hex1 = [];
  var length = USERINPUT.toString().length;
  var string = USERINPUT.toString();
  var i = void 0;
  for (i = 0; i < length; i++) {
    console.log(i);
...
var converter = _interopRequireWildcard(_script);
...
exports.default = {
  data: function data() {
    ...
    return _ref = {
      ...
      hexadecimalOut: "",
      binaryOut: ""
    }, _defineProperty(_ref, "inputType", ""), _defineProperty(_ref, "processed", 0), _ref;
  },

  methods: {
    convertInput: function convertInput() {
      var USERINPUT = this.rawInput;
    ...
    [
          ...
          [
              ...
              _c("div", { staticClass: "col-md-4" }, [
                _c("div", { staticClass: "radio" }, [
                  _c("input", {
                    ...
                    domProps: { checked: _vm._q(_vm.inputType, "Decimal") },
                    on: {
                      change: function($event) {
                        _vm.inputType = "Decimal"
                      }
                    }
                  }),
                  _vm._v(" "),
                  _c("label", { attrs: { for: "dec" } }, [_vm._v("Decimal")])
                ])
              ]),
              _vm._v(" "),
              _c("div", { staticClass: "col-md-4" }, [
                _c("div", { staticClass: "radio" }, [
                  _c("input", {
                    ...
                    domProps: { checked: _vm._q(_vm.inputType, "Hexadecimal") },
                    on: {
                      change: function($event) {
                        _vm.inputType = "Hexadecimal"
                      }
                    }
                  }),
                  _vm._v(" "),
                  _c("label", { attrs: { for: "hex" } }, [
                    _vm._v("Hexadecimal")
                  ])
                ])
              ]),
              ...
              _c("div", { staticClass: "col-md-4" }, [
                _c("div", { staticClass: "radio" }, [
                  _c("input", {
                    ...
                    domProps: { checked: _vm._q(_vm.inputType, "Binary") },
                    on: {
                      change: function($event) {
                        _vm.inputType = "Binary"
                      }
                    }
                  }),
                  _vm._v(" "),
                  _c("label", { attrs: { for: "bin" } }, [_vm._v("Binary")])
                ])
              ])
            ]),
            _vm._v(" "),
            _c("h4", [_vm._v("Your number to convert:")]),
            _vm._v(" "),
            _c("input", {
              directives: [
                {
              ...
              domProps: { value: _vm.rawInput },
              on: {
                input: function($event) {
                  if ($event.target.composing) {
                    return
                  }
                  _vm.rawInput = $event.target.value
                }
              }
            }),
            _c("br"),
            ...
            _c("div", { staticClass: "checkbox" }, [
              _c("input", {
                ...
                attrs: { type: "checkbox", id: "fromNeg" },
                domProps: {
              ...
              _vm._v(" "),
              _c("label", { attrs: { for: "fromNeg" } }, [
                _vm._v(
                  "My input is negative, convert it to its negative equivalents! (please leave out the '-' from a negative decimal)"
                )
              ])
            ]),
            _vm._v(" "),
            _c(
              "button",
              {
                ...
                attrs: { type: "submit", id: "convertButton" }
              },
              [_vm._v("Convert")]
            )
          ]
      ...
      _c("center", [
        _c("table", [
          ...
          _vm._v(" "),
          _c("tr", [
            _c("td", [_vm._v("Decimal")]),
            _vm._v(" "),
            _c("td", { attrs: { id: "decOut" } }, [
              _vm._v(_vm._s(_vm.decimalOut))
            ])
          ]),
          _vm._v(" "),
          _c("tr", [
            _c("td", [_vm._v("Binary")]),
            _vm._v(" "),
            _c("td", { attrs: { id: "binOut" } }, [
              _vm._v(_vm._s(_vm.binaryOut))
            ])
          ]),
          _vm._v(" "),
          _c("tr", [
            _c("td", [_vm._v("Hexadecimal")]),
            _vm._v(" "),
            _c("td", { attrs: { id: "hexOut" } }, [
              _vm._v(_vm._s(_vm.hexadecimalOut))
            ])
          ])
        ])
      ])
